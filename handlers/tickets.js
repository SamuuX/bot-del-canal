...
module.exports = client => {
  ...
  client.on('interactionCreate', async interaction => {
    try {
      ...
      const ticket_data = await ticketSchema.find({ guildID: interaction.guild.id, autor: interaction.user.id, cerrado: false })
  ...
  client.on('interactionCreate', async interaction => {
    try {
      ...
      const ticket_data = await ticketSchema.findOne({ guildID: interaction.guild.id, canal: interaction.channel.id })
