...
async function paginacion (client, message, texto, titulo = 'Paginación', elementos_por_pagina = 5) {
  ...
  const boton_atras = new Discord.ButtonBuilder().setStyle('Success').setCustomId('Atrás').setEmoji('929001012176507040').setLabel('Atrás')
  const boton_inicio = new Discord.ButtonBuilder().setStyle('Danger').setCustomId('Inicio').setEmoji('🏠').setLabel('Inicio')
  const boton_avanzar = new Discord.ButtonBuilder().setStyle('Success').setCustomId('Avanzar').setEmoji('929001012461707335').setLabel('Avanzar')
